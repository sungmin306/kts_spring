package com.cloudschool.kts.domain.file.service;
...
import com.cloudschool.kts.domain.file.repository.FileRepository;
...
public class FileService {
    ...
    public List<ResFileUploadDto> upload(Long boardId, List<MultipartFile> multipartFiles) throws IOException {
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            ...
            String filePath =
                    "POST_" + board.getBoardId() + "_" + randomId.concat(fileName.substring(fileName.indexOf(".")));
